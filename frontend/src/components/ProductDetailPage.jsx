...
const products = [
  {
    ...
    rating: 4.5,
    reviews: 120,
    description: 'The iPhone 14 Pro is a stunning device with a powerful A16 Bionic chip, a beautiful Super Retina XDR display, and a pro-level camera system.',
    specifications: [
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 98,
    description: 'The Samsung Galaxy S23 is a premium Android phone with a stunning Dynamic AMOLED 2X display, a powerful Snapdragon 8 Gen 2 for Galaxy chip, and a versatile camera system.',
    specifications: [
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 250,
    description: 'The Sony WH-1000XM5 are the best noise-canceling headphones on the market, with a comfortable design, excellent sound quality, and industry-leading noise cancellation.',
    specifications: [
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 150,
    description: 'The MacBook Air M2 is a powerful and portable laptop with a stunning Liquid Retina display, the powerful M2 chip, and a fanless design.',
    specifications: [
      { name: 'Brand', value: 'Apple' },
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="flex items-center mb-6">
            ...
            <input type="number" defaultValue="1" min="1" className="w-16 p-2 border border-gray-300 rounded-md" />
          </div>

          <button className="w-full bg-orange text-white py-3 rounded-md hover:bg-orange-dark">Add to Cart</button>
        </div>
      </div>
