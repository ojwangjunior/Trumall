          ...
          <div>
            ...
            <div className="flex">
              <input
                ...
                className="bg-gray-700 text-white px-3 py-2 rounded-l-md focus:outline-none"
              />
              <button className="bg-orange text-white px-4 py-2 rounded-r-md hover:bg-orange-dark">
                GO
              </button>
            </div>
          </div>
